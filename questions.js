// In dieser Datei werden alle Quizfragen gespeichert.
// Sie können diesen Array bearbeiten, um Fragen hinzuzufügen, zu ändern oder zu löschen.

const initialRawQuestions = [
    // --- Musterprüfung questions from mögliche Fragen Abschlussprüfung.pdf ---
    {
    ...
    },
    {
        ...
        answers: ["Social-Media-Content ist sehr teuer in der Produktion.", "Eine erfolgreiche Content-Marketing-Strategie erfordert die Zusammenarbeit verschiedener Abteillungen.", "Content sollte über verschiedene Kanäle hinweg konsistent sein.", "Content ist nur in Verbindung mit Werbebudget erfolgreich einsetzbar."],
    ...
    },
    {
        ...
        correct: ["Sales Funnel", "AIDA-Modell"]
    },
    {
    ...
    },
    {
        ...
        answers: ["Welche Relevanz haben einzelne Social Networks für meine Zielgruppe?", "Welche Ressourcen sind für das Bespielen notwendig?", "Die aktive Suche, Ansprache und Bindung von qualifizierten Kandidaten", "Wie ist das (Nutzungs-) Verhalten meiner Zielgruppe?"],
    ...
    // --- Quiz LF questions from Quiz LF Fragen.pdf ---
    {
        name: "Quiz LF A.1 Frage 01",
        question: "Was ist der Unterschied zwischen Sales Funnel und Customer Journey?",
        answers: ["Sales Funnel: Kaufprozess bis zum erfolgreichen Abschluss.", "Customer Journey: Betrachtet die gesamte Reise des Kunden."],
        correct: ["Sales Funnel: Kaufprozess bis zum erfolgreichen Abschluss.", "Customer Journey: Betrachtet die gesamte Reise des Kunden."]
    },
    {
    ...
    },
    {
        ...
        correct: ["First Party Daten sind Informationen, die ein Unternehmen direkt von seinen Kunden oder Zielgruppen über eigene Kanäle sammelt.", "Sie entstehen durch Interaktionen wie Website-Besuche, Käufe, Umfragen und andere direkte Engagements.", "Da sie direkt vom Nutzer stammen, gelten sie als besonders wertvoll und zuverlässig."]
    },
    {
        name: "Quiz LF A.1 Frage 07",
        question: "Wie viele Menschen erschaffen aktiv Content in den Sozialen Medien?",
        answers: ["Nach der 90-9-1 Regel:", "90% der Nutzer sind \"Lurker\", die Inhalte konsumieren, ohne aktiv zu interagieren.", "9% der Nutzer sind aktive Teilnehmer, die kommentieren, aber keine eigenen Inhalte erstellen.", "1% der Nutzer sind Inhaltsersteller, die die Mehrheit der Inhalte produzieren."],
        correct: ["Nach der 90-9-1 Regel:", "90% der Nutzer sind \"Lurker\", die Inhalte konsumieren, ohne aktiv zu interagieren.", "9% der Nutzer sind aktive Teilnehmer, die kommentieren, aber keine eigenen Inhalte erstellen.", "1% der Nutzer sind Inhaltsersteller, die die Mehrheit der Inhalte produzieren."]
    },
    {
        name: "Quiz LF A.1 Frage 08",
    ...
    },
    {
        ...
        answers: ["a) Business-Plattform.", "b) Videoplattform.", "c) Suchmaschine.", "d) Soziales Netzwerk."],
        correct: ["d) Soziales Netzwerk."]
    },
    {
        name: "Quiz LF B.1 Frage 02",
        question: "Was ist ein zentraler Erfolgsfaktor für das Community Building auf Facebook?",
        answers: ["a) Quantität vor Qualität - Hauptsache viele Fans.", "b) Influencer-Marketing mit TikTok-Creators.", "c) Nur Beiträge mit Gewinnspielen posten.", "d) Relevanter und hochwertiger Content für die Zielgruppe."],
        correct: ["d) Relevanter und hochwertiger Content für die Zielgruppe."]
    },
    {
        name: "Quiz LF B.1 Frage 03",
        question: "Wie heißt das Kurzvideoformat bei Instagram?",
        answers: ["a) Reels.", "b) Snaps.", "c) Vidz.", "d) IGTV."],
        correct: ["a) Reels."]
    },
    {
    ...
    },
    {
        ...
        answers: ["a) Die Rechte am hochgeladenen Material bleiben vollständig beim Erstellenden.", "b) Der Fokus liegt auf künstlerisch anspruchsvollen Videos.", "c) Es besticht in seinem Aufbau durch eine große Schlichtheit.", "d) Es bietet mehr Monetarisierungsmöglichkeiten."],
        correct: ["a) Die Rechte am hochgeladenen Material bleiben vollständig beim Erstellenden.", "b) Der Fokus liegt auf künstlerisch anspruchsvollen Videos.", "c) Es besticht in seinem Aufbau durch eine große Schlichtheit."]
    },
    {
        name: "Quiz LF B.2 Frage 02",
        question: "Was bedeutet der Discovery-Faktor in Bezug auf TikTok?",
        answers: ["a) Nutzende gehen auf \"Entdeckungsreise\" und lassen sich durch neue Inhalte überraschen und inspirieren.", "b) Nutzende schauen sich Inhalte von Creators und Kanälen an, die sie bereits kennen und abonniert haben."],
        correct: ["a) Nutzende gehen auf \"Entdeckungsreise\" und lassen sich durch neue Inhalte überraschen und inspirieren."]
    },
    {
    ...
    },
    {
        ...
        answers: ["a) Google.", "b) Facebook.", "c) Microsoft.", "d) X [Twitter]."],
        correct: ["a) Google."]
    },
    {
        name: "Quiz LF B.3 Frage 01",
        question: "Was lässt sich auf Business- und Karrierenetzwerken gut umsetzen?",
        answers: ["a) Personal Branding.", "b) Social Shopping.", "c) Social Selling.", "d) Recruiting."],
        correct: ["a) Personal Branding.", "c) Social Selling.", "d) Recruiting."]
    },
    {
        name: "Quiz LF B.3 Frage 02",
        question: "Warum ist Xing im Recruiting weiterhin sehr beliebt?",
        answers: ["a) Xing bietet viele Tools und Möglichkeiten im Recruiting.", "b) Der Eventmarkt bietet tolle Möglichkeiten für Recruiter.", "c) Über die Gruppenfunktion kann gezielt nach Bewerbenden gesucht werden.", "d) Über die Jobbörse können Stellen direkt auf der Plattform geteilt werden."],
        correct: ["a) Xing bietet viele Tools und Möglichkeiten im Recruiting.", "d) Über die Jobbörse können Stellen direkt auf der Plattform geteilt werden."]
    },
    {
        name: "Quiz LF B.3 Frage 03",
        question: "Zu welchem Unternehmen gehört Linkedin?",
        answers: ["a) Apple.", "b) Meta.", "c) Microsoft.", "d) Google."],
        correct: ["c) Microsoft."]
    },
    {
    ...
    },
    {
        ...
        correct: ["Die aufsteigende Reihenfolge nach Alter der Nutzer ist: Snapchat, TikTok, Instagram, Facebook."]
    },
    {
    ...
    },
    {
        ...
        correct: ["Ziele spielen eine entscheidende Rolle im Social Media Marketing, denn sie geben die Richtung vor und helfen dabei, die Social-Media-Aktivitäten auf die übergeordneten Unternehmensziele abzustimmen.", "Durch klar definierte Ziele können Ressourcen effektiv eingesetzt und Prioritäten gesetzt werden.", "Ziele ermöglichen es zudem, den Erfolg von Social Media Maßnahmen zu messen."]
    },
    {
    ...
    },
    {
        ...
        answers: ["Fakten verkaufen immer noch am besten.", "Unser Gehirn kann Geschichten besser verarbeiten und abspeichern.", "Gefühl schlägt in der Regel Vernunft.", "Storytelling ist die günstigste Form der Werbung."],
        correct: ["Unser Gehirn kann Geschichten besser verarbeiten und abspeichern.", "Gefühl schlägt in der Regel Vernunft."]
    },
    {
    ...
    },
    {
        ...
        answers: ["Instagram.", "X (ehemals Twitter).", "YouTube.", "Pinterest."],
        correct: ["Instagram.", "X (ehemals Twitter).", "YouTube."]
    },
    {
        name: "Quiz LF D.1 Frage 07",
        question: "Was zeichnet User Generated Content (UGC) aus?",
    ...
    },
    {
        ...
        correct: ["Ein Call to Action (CTA) ist eine Aufforderung, die das Publikum zu einer bestimmten Handlung bewegen soll.", "Ein CTA ist entscheidend, um die Interaktion zu fördern und die Nutzer durch ihre Customer Journey zu leiten.", "Ein effektiver CTA kann die Engagement-Rate steigern und zu höheren Konversionen führen."]
    },
    {
        name: "Quiz LF D.2 Frage 02",
        question: "Welche sozialen Netzwerke bieten kein Livestreaming an?",
        answers: ["Die Liste nennt LinkedIn, Pinterest, Facebook, Instagram, TikTok und X.", "Basierend auf den Informationen kann die Frage nicht beantwortet werden, da nicht explizit gesagt wird, welche davon kein Livestreaming anbieten."],
        correct: ["Basierend auf den Informationen kann die Frage nicht beantwortet werden, da nicht explizit gesagt wird, welche davon kein Livestreaming anbieten."]
    },
    {
    ...
    },
    {
        ...
        answers: ["a) Anzeigenumsatz.", "b) App-Entwicklung.", "c) Kanalmitgliedschaften."],
        correct: ["a) Anzeigenumsatz.", "c) Kanalmitgliedschaften."]
    },
    {
    ...
    },
    {
        ...
        answers: ["a) Hinweise zum Schutz der Privatsphäre.", "b) Hinweise, in welcher Form Spam formuliert sein soll.", "c) Klare Richtlinien, die Mobbing und Belästigung verbieten.", "d) Verweise auf mögliche Sanktionen."],
        correct: ["a) Hinweise zum Schutz der Privatsphäre.", "c) Klare Richtlinien, die Mobbing und Belästigung verbieten.", "d) Verweise auf mögliche Sanktionen."]
    },
    {
        name: "Quiz LF E.1 Frage 07",
        question: "Welche sozialen Netzwerke werden im Community-Service besonders gerne genutzt?",
        answers: ["a) X (Twitter).", "b) Pinterest.", "c) WhatsApp.", "d) TikTok."],
        correct: ["a) X (Twitter).", "c) WhatsApp."]
    },
    {
    ...
    },
    {
        ...
        answers: ["a) Die Reichweite unserer Beiträge.", "b) Die Entwicklung unserer Fan-/Follower-Anzahl.", "c) Mentions in Foren.", "d) Die Interaktionen zu unseren Beiträgen."],
        correct: ["a) Die Reichweite unserer Beiträge.", "b) Die Entwicklung unserer Fan-/Follower-Anzahl.", "d) Die Interaktionen zu unseren Beiträgen."]
    },
    {
    ...
    },
    {
        ...
        answers: ["a) Nutzende können ganz unterschiedliche Wörter verwenden, wenn sie über unser Unternehmen schreiben.", "b) Wir können damit die Auffindbarkeit unserer Beiträge deutlich erhöhen.", "c) Mit einer komplexen Suchanfrage und entsprechenden Keywords können wir die Ergebnisse verfeinern."],
        correct: ["a) Nutzende können ganz unterschiedliche Wörter verwenden, wenn sie über unser Unternehmen schreiben.", "c) Mit einer komplexen Suchanfrage und entsprechenden Keywords können wir die Ergebnisse verfeinern."]
    },
    {
        name: "Quiz LF G.1 Frage 04",
        question: "Was sagt die potenzielle Reichweite im Social Media Monitoring aus?",
        answers: ["a) Die geschätzte Anzahl von Personen, die einen Beitrag sehen könnten.", "b) Die Anzahl der Personen, die laut Insights tatsächlich einen Beitrag gesehen haben.", "c) Der geschätzte Anteil der Markenerwähnungen im Vergleich zu Mitbewerbenden."],
        correct: ["a) Die geschätzte Anzahl von Personen, die einen Beitrag sehen könnten."]
    },
    {
        name: "Quiz LF G.1 Frage 05",
        question: "Was wird im Rahmen einer Sentiment-Analyse analysiert?",
        answers: ["a) Es geht dabei vorrangig um das Verständnis spezifischer Themen oder Diskussionen in sozialen Medien.", "b) Es werden Stimmungen und Meinungen in sozialen Medien analysiert, um ein allgemeines Stimmungsbild bezüglich eines Produkts, einer Marke oder eines Themas zu erhalten."],
        correct: ["b) Es werden Stimmungen und Meinungen in sozialen Medien analysiert, um ein allgemeines Stimmungsbild bezüglich eines Produkts, einer Marke oder eines Themas zu erhalten."]
    },
    {
        name: "Quiz LF G.2 Frage 01",
        question: "Wie oft sollte die Erfolgskontrolle der eigenen Maßnahmen idealerweise erfolgen?",
        answers: ["a) Mindestens einmal täglich.", "b) Mindestens einmal monatlich.", "c) Lediglich im Rahmen einer Strategieentwicklung.", "d) Maximal einmal im Jahr."],
        correct: ["a) Mindestens einmal täglich."]
    },
    {
        name: "Quiz LF G.2 Frage 02",
        question: "Was sagt ein ROI mit einem Faktor von 0,8 aus?",
        answers: ["a) Dass die Investitionen in eine Kampagne mehr Kosten verursacht haben, als sie an Gewinn gebracht haben.", "b) Dass die Investitionen in eine Kampagne mehr Gewinn gebracht haben, als sie Kosten verursacht haben."],
        correct: ["a) Dass die Investitionen in eine Kampagne mehr Kosten verursacht haben, als sie an Gewinn gebracht haben."]
    },
    {
    ...
    },
    {
        ...
        question: "Was gibt die Bounce Rate im Kontext von Web Analytics an?",
        answers: ["a) Den Anteil der Nutzenden, die das Webtracking abgelehnt haben.", "b) Den Anteil der Besuchenden, die die Website nach kurzer Zeit wieder verlassen haben."],
        correct: ["b) Den Anteil der Besuchenden, die die Website nach kurzer Zeit wieder verlassen haben."]
    },
    {
        ...
        answers: ["a) Sentiment Rate.", "b) Interaktionsrate.", "c) Conversion Rate."],
        correct: ["c) Conversion Rate."]
    },
    {
        name: "Quiz LF G.2 Frage 06",
        question: "Was ist beim Einsatz des Social Media Tools Later zu beachten?",
        answers: ["a) Es ist nicht DSGVO-konform.", "b) Es bietet neben einem Analytics-Tool auch ein Planungstool an.", "c) Es unterstützt lediglich Instagram."],
        correct: ["b) Es bietet neben einem Analytics-Tool auch ein Planungstool an."]
    },
    // --- New questions from quiz lf g.pdf (after removing duplicates) ---
    {
        name: "Quiz LF G Frage 02",
    ...
    },
    {
        ...
        correct: ["Social Media Monitoring = Schaut zurück, Social Listening = Schaut in die Zukunft"]
    },
    {
        name: "Quiz LF G Frage 06",
        question: "Welche kostenlosen Tools von Google können für die Durchführung von Social Media Monitoring genutzt werden?",
        answers: ["Google Alerts", "Google Trends", "Google Alerts, Google Trends"],
        correct: ["Google Alerts", "Google Trends", "Google Alerts, Google Trends"]
    },
    {
        name: "Quiz LF G Frage 08",
    ...
    {
        name: "Quiz LF G Frage 12",
        question: "Wofür kann ein neues Set an Keywords den Suchfokus der...(+) genutzt werden?",
    ...
    {
        name: "Quiz LF G Frage 15",
        question: "Was ist der größte Vorteil der Social-Media-Monitoring aus?",
